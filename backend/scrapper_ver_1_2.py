...
class BDJobsScrapper:
    ...
    def scrap_from_page(self, page_no):
        ...
        for job in jobListings:
            ...
            if job_title:
                ...
                print("Job no:", self.row_id," - Job title:", job_title.text.strip()," - Job Domain:", results[1],  " - Job URL: ", job_url)
                self.row_id += 1
    ...
    def scrap_single_job(self, job_url):
        ...
        return (job_title,job_domain, job_url, company_name, deadline, published, vacancy, location, age, salary, experience, education, skills, workplace, employment_status, gender, job_location, benefits, company_address, company_website)
